...
fetch(BREEDS_URL) 
    ...
    //ACCESS RANDOM ELEMENTS FROM ARRAYS TO POPULATE DOGGO CHARACTERISTICS
    //CREATE AN OBJECT AND POPULATE ARRAYS AS PROPERTIES INSIDE THE OBJECT
    const doggoInfo = {
        ...
        assignAge() {
            this.age = Math.ceil(Math.random() * 9)
